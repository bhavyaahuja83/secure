...
const CreateBill: React.FC<CreateBillProps> = ({ onSuccess }) => {
  ...
  const saveClientIfNew = (bill: Bill) => {
    if (!bill.clientId && bill.clientName && bill.clientGSTIN) {
      ...
      if (!existingClient) {
        ...
        existingClient.lastBillDate = bill.date;
        existingClient.totalBilled = (existingClient.totalBilled || 0) + bill.grandTotal;
        dataStore.saveClient(existingClient);
      }
    }
  };
                  ...
                  <div className="max-h-96 overflow-y-auto">
                    {filteredClients.length > 0 ? (
                      ...
                      <div className="text-center text-gray-500 py-8">
                        No clients found. Enter client details below to create a new client.
                      </div>
                    )}
                  </div>
                </div>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="flex justify-end mt-6">
              <Button onClick={generateBill} className="bg-green-600 hover:bg-green-700">
                Generate Bill
              </Button>
            </div>
          </CardContent>
